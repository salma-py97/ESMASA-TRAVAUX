			...
			>
				...
				>
                  ...
                  {/* Nous nous engageons à maintenir un environnement propre et sain pour nos employés, nos clients et partenaires. Nous nous efforçons de garantir le succès à long terme de tous nos projets. */}
									Nos constructions sont conçues en se basant sur les meilleures pratiques conjuguant qualité, résistance et éfficacité sur le long terme en s'intégrant parfaitement dans l'environnement avec délai et coûts optimisés.
								</p>
							</div>
						</div>
					</div>
						...
						<div className={`row ${reason_div}`}>
							...
							<div className="col-9">
								...
								<p className={reason}>
									...
									Notre ingénierie et notre esprit de créativité nous permettent de performer dans la conception des ouvrages et d’innover pour rendre les réalisations toujours plus compétitives et pérenniser notre entreprise.
								</p>
							</div>
						</div>
					</div>
                  ...
                  {/* ESMASA Travaux dispose d'une gestion moderne et d'un personnel technique hautement qualifié. Nous sommes entièrement cautionnés et assurés. Nos travailleurs sont formés aux dernières normes de sécurité et aux exigences du secteur. */}
									La complexité des projets que nous réalisons exige des compétences humaines adéquates et une expertise technique très avancée. Pour remporter ce défit, Esmasa travaux veille sur la formation continue de ses employés aux dernières normes de sécurité et aux exigences du secteur.
								</p>
							</div>
						</div>
					</div>
					<div className="col-md-6 mb-3">
						<div className={`row ${reason_div}`}>
							...
							<div className="col-9">
								...
								<p className={reason}>Nous favorisons la démarche écoute Clients dans la conduite de nos projets en associant l’ensemble des parties prenantes concernées : autorité locale, acteurs économiques locaux, associations, riverains, employés...
								Tout au long de la réalisation de nos projets, l'amélioration continue de la satisfaction de nos clients reste notre priorité.
								</p>
							</div>
						</div>
					</div>
                  ...
                  {/* Nous nous engageons à prendre toutes les précautions pour éviter les incidents et maintenir un environnement sécurisé et sain. */}
									ESMASA Travaux a mis en place un système de management intégré Qualité, Hygiène, Sécurité et Environnement pour être en conformité avec les exigences des normes ISO en vigueur.
								</p>
							</div>
						</div>
					</div>
                  ...
                  {/* Notre expertise est sollicitée pour un large éventail de projets, notamment la construction des bâtiments de grande ou petite taille et les travaux d'assainissement. */}
									Parmi nos valeurs, l'implication et l'engagement citoyens de ses employés. A cet égard, nous menons des actions fortes pour l'insertion sociale et professionnelle dans nos divers chantiers.
