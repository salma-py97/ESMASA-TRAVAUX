    ...
    <div className={`d-flex justify-content-center align-items-center py-5 ${wrapper}`}>
      <div className="row container d-flex justify-content-around align-items-center text-center">
        <div className="col-md-3 d-flex flex-column justify-content-center align-items-center">
          ...
          <p className={`lead ${p}`}>Clients Satisfaits  <span className={extra}>extratext</span></p>
        </div>
        <div className="col-md-3 d-flex flex-column justify-content-center align-items-center">
          <h1 className={title} >240</h1>
          <p className={`lead ${p}`}>Projets Réussis  <span className={extra}>extratext</span></p>
        </div>
        <div className="col-md-3 d-flex flex-column justify-content-center align-items-center">
          <h1 className={title} >34</h1>
          <p className={`lead ${p}`}>Ingénieurs Expérimentés</p>
        </div>
        <div className="col-md-3 d-flex flex-column justify-content-center align-items-center">
