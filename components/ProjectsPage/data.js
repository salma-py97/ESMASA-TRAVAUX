...
export const projectTwo = {
  ...
  lieu: "Salé",
  date: "6 mois",
  prestations: ["Travaux de terrassement, fourniture, transport et pose d'une conduite en PVC", "Travaux de terrassement, fourniture, transport et pose d'une conduite en fonte ductile", "Travaux de terrassement, fourniture, transport et pose de tuyaux en PVC", "Fourniture, transport et pose des pièces spéciales de raccords", "Fourniture, transport et pose d'un réducteur de pression", "Fourniture, transport et pose d'un débitmètre électromagnétique", "Construction des regards en béton armé pour abriter les équipements hydromécaniquesà poser"]
}
