...
const YellowBreak = () => {
  ...
  return (
    <div className={`bg-warning text-white text-start p-5 d-flex justify-content-center align-items-center ${bg}`}>
      <div className="py-5 d-flex justify-content-between align-items-start flex-column" >
      <h2>IF YOU HAVE A PROJECT, WE WOULD TO HELP YOU OUT</h2>
      <p className="lead mt-3 mb-4">TRUST US WITH YOU IDEAS AND WE WILL BRING THEM TO LIFE</p>
